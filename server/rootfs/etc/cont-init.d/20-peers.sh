...
op inject -i /etc/wireguard/wg0.conf.tpl -o /etc/wireguard/wg0.conf -f 

op read op://6akxllxi2gxokxmsfxy5yrouiq/3ocjh6cfeiqim5w53o4apcyczi/notesPlain >> /etc/wireguard/wg0.conf 